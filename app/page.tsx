      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed animate-fade-in-up animation-delay-400">
            Connect all your transport accounts and get a unified view of your travel data, spending
            patterns, and environmental impact across every journey.
          </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto mb-16">
            {DEMO_ACCOUNTS.map((account, index) => (
              <Card
                key={account.id}
                className={`group hover:shadow-2xl transition-all duration-500 cursor-pointer border-2 transform hover:-translate-y-2 ${
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-xl">
              <CardContent className="p-12 text-center">
                ...
                <h4 className="text-2xl font-bold text-gray-900 mb-4">
                  Demonstrating Unified Transport Data
                </h4>
                <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                  This demo showcases how transport data from multiple providers can be unified into
                  a single, coherent dashboard experience. Real authentication and live data
