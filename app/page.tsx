				...
				<section id="demo-section" className="py-20 bg-white">
					<div className="container mx-auto px-4">
						...
						<div className="text-center mb-16">
							<Badge className="mb-4 bg-openTransport-primary/10 text-[#002d9c] border-openTransport-primary/20 hover:bg-openTransport-primary hover:text-white transition-colors">
								Interactive Demo
							</Badge>
